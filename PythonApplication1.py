...
# print(image_list[0])
imagini = []
#folder_dir = "D:\games_image_recognition-master\assassin"
# for images in os.listdir(folder_dir):
nr = 0
    # check if the image ends with png
    #if (images.endswith(".jpg")):
     #   print(images)
f = r"C:\Users\calui\OneDrive\Desktop\game_img_recognition-master\detoate\assassin"
for file in os.listdir(f):
    ...
    img.save(f_img)
    nr=nr+1
f = r"C:\Users\calui\OneDrive\Desktop\game_img_recognition-master\detoate\monopoly"
for file in os.listdir(f):
    f_img = f+"/"+file
    img = Image.open(f_img)
   # img = img.resize((300,300))
    ...
    nr=nr+1
    print(nr)
f = r"C:\Users\calui\OneDrive\Desktop\game_img_recognition-master\testare"
for file in os.listdir(f):
    f_img = f+"/"+file
    img = Image.open(f_img)
    #img = img.resize((300,300))
...
img_height = 300
img_width  = 300
f = r"C:\Users\calui\OneDrive\Desktop\game_img_recognition-master\detoate"
